...
if !$_GET.key? 'stage'
  ...
  # @see PaynetEasy::PaynetEasyApi::Query::SaleQuery, @request_fields_definition
  ...
  # @see PaynetEasy::PaynetEasyApi::Query::SaleQuery.update_payment_on_success()
  payment_processor.execute_query 'sale', payment_transaction
