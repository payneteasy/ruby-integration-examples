...
if !$_GET.key? 'stage'
  ...
  # @see PaynetEasy::PaynetEasyApi::Query::TransferFormQuery, @request_fields_definition
  ...
  # @see PaynetEasy::PaynetEasyApi::Query::TransferFormQuery.update_payment_on_success()
